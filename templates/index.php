...
<div id="main">
    ...
    <?php if ($thread): ?>
        <section>
            <h1>
                <a href="detai.php?id=<?php echo htmlentities($thread['id_thread']); ?>">Hottest thread: <?php echo htmlentities($thread['name_thread']); ?></a>
            ...
            <a href="detai.php?id=<?php echo htmlentities($thread['id_thread']); ?>">Read more</a>
        </section>
    <?php endif; ?>
    ...
    <footer>
        Copyright &copy; 2014 <strong>IT Help</strong> - ICT Championships 2014 <br /> Candidate information
    </footer>
</div>
</body>
